...
android { namespace = "com.natan.cryptowatch"; compileSdk = 35
    defaultConfig { applicationId = "com.natan.cryptowatch"; minSdk = 26; targetSdk = 35; versionCode = 1; versionName = "1.0" }
